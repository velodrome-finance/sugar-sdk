...
class AsyncChain(CommonChain):
    ...
    async def _deposit_basic(self, quote: DepositQuote, delay_in_minutes: float, slippage: float):
        ...
        print(f"gonna deposit {a0} {pool.token0.symbol} + {a1} {pool.token1.symbol} into {pool.symbol} from {self.account.address}")
    ...
    async def _deposit_concentrated(self, quote: DepositQuote, delay_in_minutes: float, slippage: float):
        ...
        print(f"gonna deposit {a0} {pool.token0.symbol} + {a1} {pool.token1.symbol} into {pool.symbol} [{quote.tick_lower}, {quote.tick_upper}] from {self.account.address}")
        ...
        print(f"minting CL position with params: {params}")
